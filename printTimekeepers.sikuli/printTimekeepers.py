...
# - - - - - - - - - - - - - - - - - - - - - - - - - #
def Print_Timekeepers():
# - - - - - - - - - - - - - - - - - - - - - - - - - #
 
    logging.debug(' ')
    logging.debug('Print_Timekeepers')
    ...
    type(Key.END)
    time.sleep(1)    
    doubleClick("TimckacncrIn.png")
    click("MZElpticns.png")
    click("1352843528241.png")
    click("Showcverhead.png")
    type(Key.ENTER)
...
# choose CSV
    ...
    if Settings.tsVersion == "2014":
        type(Settings.repFolder + "\\NewReports\\timekeeperlist.csv")
    else:
        type(Settings.repFolder + "\\OldReports\\timekeeperlist.csv")        
