...
#---------------------------------------------------#
def Hold_Bill_AllBills_AmountAndHours():
#---------------------------------------------------#
...
#---------------------------------------------------#
    ...
    Hold_Time_NextBill_Hours()
    Hold_Exp_AllBills_Amount()
    Hold_Bill_AllBills_AmountAndHours()
    Hold_AR_AllBills()
